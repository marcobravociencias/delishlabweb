    ...
    return (
        <div className="bg-white">
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                ...
                <h1 className="py-6 text-3xl font-semibold tracking-tight text-gray-900 sm:text-3xl">Frappes</h1>

                <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">

                    {bebidas_frappes.map((bebidaF) => (
                        <a key={bebidaF.id} href={bebidaF.href} className="group">
                            <img
                                alt={bebidaF.imageAlt}
                                src={bebidaF.imageSrc}
                                className="aspect-square w-full overflow-hidden rounded-lg object-cover group-hover:opacity-75 sm:aspect-square"
                            />
                            <div className="mt-4 flex items-center justify-between text-base font-medium text-gray-900">
                                <h3>{bebidaF.name}</h3>
                            ...
                            <p className="mt-1 text-sm text-gray-500 italic">{bebidaF.description}</p>
                        </a>
                    ))}
                </div>
